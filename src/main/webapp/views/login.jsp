...
<body style="height: 100%; width: 100%; overflow: hidden; border: none;">
	<button
		onclick="javascript:window.location.href='${ pageContext.request.contextPath }/user/toRegist';">
	...
	<div id="win" class="easyui-window"
		title="<fmt:message key="i18n.login.title"></fmt:message>"
		...
		<x:form action="${ pageContext.request.contextPath }/user/Login"
			...
			<div style="padding: 5px; text-align: center;">
				<a href="#" class="easyui-linkbutton" icon="icon-ok"
					onclick="javascript:$('#loginFrom').submit();"><fmt:message
						key="i18n.login.title"></fmt:message></a> <a href="#"
